...
if __name__ == '__main__':
    df_prod, df_profile, df_mean_profile, df_asset, sub_df_asset = extract_prod(prod_path=profile, prod_pct_path=profile, mean_pct_path=profile, asset_path=template_asset)
