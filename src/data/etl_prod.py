...
if __name__ == '__main__':
    df_productibles, df_profile, df_project_names, df_template_asset = extract_prod(productible_path=productibles, 
    ...
    load_prod(dest_dir=dest_dir, src_productible=df_prod, src_profile_id=df_profile_id, 
