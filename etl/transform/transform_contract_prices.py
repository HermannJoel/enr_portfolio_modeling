...
def transform_contract_prices_planif(self, df_hedge=None):
    try:
        if df_hedge is None:
...
def transform_contract_price_ppa(template_asset, df_ppa, **kwargs):
    """
    ...
    **kwargs
    ...
    try:
        ...
        remove_contract_prices(d, *args, **kwargs)
        ...
        print("Data transformation eror!")
        
def transform_contract_prices_inprod(template_asset, df_ppa, **kwargs):
    """
    udf Function to generate template contracts prices asset in prod
    Parameters
    ===========
